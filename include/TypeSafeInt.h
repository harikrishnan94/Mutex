...
template <typename IntType, typename Tag>
struct std::is_integral<TypeSafeInt<IntType, Tag>> : public true_type
{};

template <typename IntType, typename Tag>
struct std::numeric_limits<TypeSafeInt<IntType, Tag>>
{
	using type = TypeSafeInt<IntType, Tag>;
...
template <typename IntType, typename Tag>
struct std::atomic<TypeSafeInt<IntType, Tag>>
{
	using Type = TypeSafeInt<IntType, Tag>;
